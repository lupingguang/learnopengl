...
static Shader shader, normalShader;
static Model TDModel;
...
int main()
{
    ...
    normalShader = Shader("geometry_shader.vs", "geometry_shader.fs", "geometry_shader.gs");
    TDModel  = Model("./backpack/backpack.obj");
